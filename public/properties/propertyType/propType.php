<?php
	#Property Type
	if(array_key_exists("propTypeName",$priModObj[0]->domFields)){
		$priModObj[0]->domFields["prcn"] = '
		<div 
			class="propTypeName propTypeName-' . $priModObj[0]->className . '" 
			id="propTypeName-' . $priModObj[0]->className . '-' . $priModObj[0]->queryResults["priKeyID"] . '">' . $priModObj[0]->queryResults["propertyType"] .'
		</div>';
	}
	#Property Type Description
	if(array_key_exists("propTypeDesc",$priModObj[0]->domFields)){
		$priModObj[0]->domFields["prcn"] = '
		<div 
			class="propTypeDesc propTypeDesc-' . $priModObj[0]->className . '" 
			id="propTypeDesc-' . $priModObj[0]->className . '-' . $priModObj[0]->queryResults["priKeyID"] . '">' . $priModObj[0]->queryResults["propertyTypeDescription"] .'
		</div>';
	}
