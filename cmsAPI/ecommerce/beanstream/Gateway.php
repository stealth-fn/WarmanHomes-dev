...
require_once $_SERVER['DOCUMENT_ROOT']."/cmsAPI/ecommerce/beanstream/Exception.php";
require_once $_SERVER['DOCUMENT_ROOT']."/cmsAPI/ecommerce/beanstream/Configuration.php";
require_once $_SERVER['DOCUMENT_ROOT']."/cmsAPI/ecommerce/beanstream/communications/Endpoints.php";
require_once $_SERVER['DOCUMENT_ROOT']."/cmsAPI/ecommerce/beanstream/communications/HttpConnector.php";
require_once $_SERVER['DOCUMENT_ROOT']."/cmsAPI/ecommerce/beanstream/api/Payments.php";
require_once $_SERVER['DOCUMENT_ROOT']."/cmsAPI/ecommerce/beanstream/api/Profiles.php";
require_once $_SERVER['DOCUMENT_ROOT']."/cmsAPI/ecommerce/beanstream/api/Reporting.php";
